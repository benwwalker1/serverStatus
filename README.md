...
Updated (Central US): **2026-02-11 10:17:01 CST**
Updated (Central EU): **2026-02-11 17:17:01 CET**
Updated (UTC): **2026-02-11T16:17:01Z**
...
| ------ | ------- | ----------- | ------------ | -------------- | ------------- | ------------- | --------------- | --------------- |
| nsc1.utdallas.edu | 3 | 0.00% | 0.00% | 0.00% | NA | NA | 0 | 0 |
| nsc2.utdallas.edu | 3 | 0.00% | 0.00% | 0.00% | NA | NA | 0 | 0 |
| nsc3.utdallas.edu | 3 | 0.00% | 0.00% | 0.00% | NA | NA | 0 | 0 |
| nsc4.utdallas.edu | 3 | 0.00% | 0.00% | 0.00% | NA | NA | 0 | 0 |
...
2. **CUDA health**: SSH + `nvidia-smi --query-gpu=utilization.gpu --format=csv,noheader,nounits`; command stderr/failure now marks CUDA as error.
3. **No mumax3 errors**: SSH + `mumax3 -version` (fallback to `mumax3 -v` / `mumax3`).
